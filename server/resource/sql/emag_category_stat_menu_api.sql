...
(NOW(), NOW(), '/emagCategoryStat/getList', '分页获取品类指标列表', 'Emag品类指标', 'GET'),
(NOW(), NOW(), '/emagCategoryStat/getGrowthRank', '分页获取热销增长率排名', 'Emag品类指标', 'GET');
...
('p', '888', '/emagCategoryStat/getList', 'GET'),
